...
local L_10_ = {
    ...
    Themes = {
        Default = {
            Main = Color3.fromRGB(30, 30, 40), -- Slightly lighter
            Second = Color3.fromRGB(40, 40, 50), -- Slightly lighter
            Stroke = Color3.fromRGB(45, 45, 55), -- Slightly lighter
            Divider = Color3.fromRGB(70, 70, 80), -- Slightly lighter
            Text = Color3.fromRGB(255, 255, 255), -- Pure white for better contrast
            TextDark = Color3.fromRGB(180, 180, 180) -- Slightly lighter
        }
    },
